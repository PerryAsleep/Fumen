...
using static Fumen.ActionQueueUtils;

namespace Fumen;

/// <summary>
/// UndoableAction to set a Field or a Property for a reference type on an object.
/// </summary>
/// <typeparam name="T">
/// Reference type of object field or property.
/// Must be Cloneable to ensure save undo and redo operations.
/// </typeparam>
public sealed class ActionSetObjectFieldOrPropertyReference<T> : UndoableAction where T : class, ICloneable
{
