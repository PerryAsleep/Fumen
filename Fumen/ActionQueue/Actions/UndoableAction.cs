...
/// UndoableActions may be synchronous or asynchronous.
/// To do or undo an UndoableAction, it must not currently be asynchronously being done or undone.
/// Attempting to do or undo a currently running asynchronous UndoableAction will have no effect.
/// </summary>
public abstract class UndoableAction
{
	/// <summary>
	/// State of an UndoableAction.
	/// </summary>
	internal enum State
	{
		/// <summary>
	...
	/// <summary>
	/// The current state of this UndoableAction.
	/// </summary>
	...
	protected UndoableAction(bool isDoAsync, bool isUndoAsync)
	{
	...
	/// Synchronous actions will have this called automatically by UndoableAction.
	/// </summary>
	...
	/// <summary>
	/// Returns whether or not this action represents a change to an underlying file.
	/// Used by ActionQueue to determine if there are unsaved changes.
	/// </summary>
