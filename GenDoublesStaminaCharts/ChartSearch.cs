...
{
	// TODO: Move this logic into ExpressedChart
	public class ChartSearch
	{
		public class ChartSearchNode : IEquatable<ChartSearchNode>
		{
		...
		public static ExpressedChart FindExpressedChart(List<Event> events, StepGraph stepGraph)
		{
		...
		private static void SetExpressedChartEvents(ExpressedChart expressedChart, int numArrows, ChartSearchNode root, List<MineEvent>[] minesByArrow)
		{
			var lastReleases = new MetricPosition[numArrows];
